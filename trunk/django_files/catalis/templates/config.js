...
Ext.apply(Config, {
    ...
    */
    ...
    EXTERNAL_SITES: [{
        title: 'LC_CATALOG', //Lang.TABS.LC_CATALOG,  // Should this title depend on the user's language?
...
var g_userid = "{{ user.username }}";  // the current user
